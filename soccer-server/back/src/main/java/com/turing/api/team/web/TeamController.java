...
public class TeamController {
    ...
    public ResponseEntity<List<?>> searchTeam(
        ...
        log.info("MY-INFO : Controller searchTeam q is {}", q);
        log.info("MY-INFO : Controller searchTeam page is {}", pageable.getPageNumber());
        log.info("MY-INFO : Controller searchTeam limit is {}", pageable.getPageSize());
        log.info("MY-INFO : Controller searchTeam sortField is {}", pageable.getSort().toString());
